...
class CascadeModel:
    ...
    def __init__(self, input_size, r_rate=0.0, dr_rate=0.0):
        ...
        # Add pooling layers until to follow original architecture
        while model.output_shape >= org_input:
            model.add(MaxPool2D(pool_size=(2, 2)))
        assert model.output_shape == org_input, ("Incorrect input shape, "
